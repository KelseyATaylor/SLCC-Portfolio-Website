...
<body>
			...
			<div class="row justify-content-center">
				<div class="col-6">
					...
					<form action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> method="POST" novalidate>
                        ...
                        <div class = "text-danger text-right">* Indicates required field.</div>
    ...
    <!-- Note, the above means: "If the request method is set to post and the form error message is not true, then show the results section. If either statement is false, then the results section will not show." -->
	<!-- 
